...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (d, l, u) {
...
(function (d) {
    d.fn.tableExport = function (l) {
        ...
        function x(b, c) {
            var a = b[0].tagName, h = b.parents(a).length;
        ...
        function P(b) {
            var c = [];
            d(b).find("thead").first().find("th").each(function (b, a) {
        ...
        function Q(b) {
            var c = "undefined" !== typeof b[0].cellIndex, a = "undefined" !== typeof b[0].rowIndex,
                h = c || a ? Ea(b) : b.is(":visible"), g = b.data("tableexport-display");
        ...
        function Ea(b) {
            var c = [];
            U && (c = I.filter(function () {
                var c = !1;
                this.nodeType === b[0].nodeType && ("undefined" !== typeof this.rowIndex && this.rowIndex === b[0].rowIndex ? c = !0 : "undefined" !== typeof this.cellIndex && this.cellIndex === b[0].cellIndex && "undefined" !== typeof this.parentNode.rowIndex && "undefined" !== typeof b[0].parentNode.rowIndex && this.parentNode.rowIndex === b[0].parentNode.rowIndex && (c = !0));
                return c
            }));
        ...
        function Fa(b, c, f) {
            var h = !1;
            Q(b) ? 0 <
                a.ignoreColumn.length && (-1 !== d.inArray(f, a.ignoreColumn) || -1 !== d.inArray(f - c, a.ignoreColumn) || R.length > f && "undefined" !== typeof R[f] && -1 !== d.inArray(R[f], a.ignoreColumn)) && (h = !0) : h = !0;
            return h
        }
        ...
        function D(b, c, f, h, g) {
            if ("function" === typeof g) {
                ...
                if (!1 === k && -1 === d.inArray(f, a.ignoreRow) && -1 === d.inArray(f - h, a.ignoreRow) && Q(d(b))) {
                    var y = x(d(b), c), q = 0;
                    y.each(function (b) {
                        var c = d(this), a, h = S(this), k = T(this);
                        d.each(F, function () {
                            if (f >= this.s.r &&
                                f <= this.e.r && q >= this.s.c && q <= this.e.c) for (a = 0; a <= this.e.c - this.s.c; ++a) g(null, f, q++)
                        });
        ...
        function pa(b, c, a, d) {
            if ("undefined" !== typeof d.images && (a = d.images[a], "undefined" !== typeof a)) {
                ...
                var g = b.width / b.height,
                    f = c.width / c.height, h = b.width, q = b.height, e = 19.049976 / 25.4, l = 0;
        ...
        function ra(b, c, a) {
            ...
            if (0 <= d) {
                ...
                b.textPos.x = f;
                "undefined" !==
                typeof a && 1 < a.rowspan && (b.height *= a.rowspan);
        ...
        function sa(b, a, f) {
            "undefined" !== typeof b && null !== b && (b.hasAttribute("data-tableexport-canvas") ? (a = (new Date).getTime(), d(b).attr("data-tableexport-canvas", a), f.images[a] = {
                ...
                if (b.url) if (b.src) {
                    ...
                    c.onerror = c.onload = function () {
                        if (c.complete && (0 === c.src.indexOf("data:image/") && (c.width = b.width || c.width || 0, c.height = b.height || c.height || 0), c.width + c.height)) {
                            var d = document.createElement("canvas"), f = d.getContext("2d");
                            d.width = c.width;
                            d.height = c.height;
                            f.drawImage(c, 0, 0);
                    ...
                    var f = d(b.url);
                    f.length && (h = ++g, html2canvas(f[0]).then(function (c) {
            ...
            c.each(function () {
                if (d(this).is("div")) {
                    var c = ba(K(this, "background-color"), [255, 255, 255]),
                        g = ba(K(this, "border-top-color"), [0, 0, 0]), k = ca(this, "border-top-width", a.jspdf.unit),
        ...
        function va(b, c, f) {
            if ("function" === typeof f.onAutotableText) f.onAutotableText(f.doc, b, c); else {
                var h = b.textPos.x, g = b.textPos.y, k = {
                ...
                if (c.length) {
                    ...
                    for (var y = !1, q = !1; c;) {
                        var e = c.innerText || c.textContent || "", l = e.length && " " === e[0] ? " " : "",
        ...
        function B(b, c, f) {
            ...
            if (null !== b) {
                var g = d(b);
                if (g[0].hasAttribute("data-tableexport-canvas")) var k = ""; else if (g[0].hasAttribute("data-tableexport-value")) k = (k = g.data("tableexport-value")) ? k + "" : ""; else if (k = g.html(), "function" === typeof a.onCellHtmlData) k =
                    a.onCellHtmlData(g, c, f, k); else if ("" !== k) {
                    var e = d.parseHTML(k), q = 0, l = 0;
                    k = "";
                    d.each(e, function () {
                        if (d(this).is("input")) k += g.find("input").eq(q++).val(); else if (d(this).is("select")) k += g.find("select option:selected").eq(l++).text(); else if (d(this).is("br")) k += "<br>"; else if ("undefined" === typeof d(this).html()) k += d(this).text(); else if (void 0 === jQuery().bootstrapTable || !0 !== d(this).hasClass("filterControl") && 0 === d(b).parents(".detail-view").length) k += d(this).html()
                    })
                }
                if (!0 === a.htmlContent) h = d.trim(k);
                else if (k && "" !== k) if ("" !== d(b).data("tableexport-cellformat")) {
                    var m = k.replace(/\n/g, "\u2028").replace(/(<\s*br([^>]*)>)/gi, "\u2060"),
                    ...
                    h = h.replace(/\u00A0/g, " ");
                    if ("json" ===
                        a.type || "excel" === a.type && "xmlss" === a.mso.fileFormat || !1 === a.numbers.output) e = ja(h), !1 !== e && (h = Number(e)); else if (a.numbers.html.decimalMark !== a.numbers.output.decimalMark || a.numbers.html.thousandsSeparator !== a.numbers.output.thousandsSeparator) if (e = ja(h), !1 !== e) {
                        n = ("" + e.substr(0 > e ? 1 : 0)).split(".");
                        1 === n.length && (n[1] = "");
                        var p = 3 < n[0].length ? n[0].length % 3 : 0;
                        h = (0 > e ? "-" : "") + (a.numbers.output.thousandsSeparator ? (p ? n[0].substr(0, p) + a.numbers.output.thousandsSeparator : "") + n[0].substr(p).replace(/(\d{3})(?=\d)/g,
                            "$1" + a.numbers.output.thousandsSeparator) : n[0]) + (n[1].length ? a.numbers.output.decimalMark + n[1] : "")
                    }
                } else h = k;
        ...
        function xa(b) {
            var a =
                K(b, "text-align"), d = K(b, "font-weight"), h = K(b, "font-style"), g = "";
        ...
        function S(b) {
            ...
            "undefined" === typeof a && d(b).is("[colspan]") &&
            (a = d(b).attr("colspan"));
            return parseInt(a) || 0
        }
        ...
        function Ja(b) {
            for (var a = {}, d = {
                s: {c: 1E7, r: 1E7},
                e: {c: 0, r: 0}
            }, h = 0; h !== b.length; ++h) for (var g = 0; g !== b[h].length; ++g) {
                d.s.r > h && (d.s.r = h);
                d.s.c > g &&
                (d.s.c = g);
                d.e.r < h && (d.e.r = h);
        ...
        function G(a, c, d) {
            ...
            if (!1 !== a && window.navigator.msSaveOrOpenBlob) window.navigator.msSaveOrOpenBlob(new Blob([d]), a); else if (!1 !== a && (0 < b.indexOf("MSIE ") || b.match(/Trident.*rv:11\./))) {
                ...
                if (g) {
                    ...
                    "object" === typeof d ? (window.URL = window.URL || window.webkitURL, a = [], a.push(d), k = window.URL.createObjectURL(new Blob(a, {type: c})), g.href = k) : 0 <= c.toLowerCase().indexOf("base64,") ? g.href = c + J(d) : g.href = c + encodeURIComponent(d);
                    document.body.appendChild(g);
                    if (document.createEvent) null === ea && (ea = document.createEvent("MouseEvents")), ea.initEvent("click", !0, !1), g.dispatchEvent(ea); else if (document.createEventObject) g.fireEvent("onclick"); else if ("function" === typeof g.onclick) g.onclick();
                    setTimeout(function () {
        ...
        function J(a) {
            ...
            if ("string" === typeof a) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    128 > k ? g += String.fromCharCode(k) : (127 < k &&
                    2048 > k ? g += String.fromCharCode(k >> 6 | 192) : (g += String.fromCharCode(k >> 12 | 224), g += String.fromCharCode(k >> 6 & 63 | 128)), g += String.fromCharCode(k & 63 | 128))
                }
                a = g
            }
            for (; h < a.length;) {
                ...
                d = d + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(q) +
        ...
        var a = {
            ...
            tabloid: [792, 1224],
            "credit-card": [153, 243]
        }, v = this, ea = null, r = [], t = [], n = 0, p = "", R = [], F = [], I = [], U = !1;
        d.extend(!0, a, l);
        ...
        "undefined" === a.mso.pageOrientation && (a.mso.pageOrientation = a.excelPageOrientation);
        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            var la = function (b, c, f) {
                b.each(function () {
                    ...
                    D(this, c, n, f + b.length, function (b, d, c) {
                        var g = p, k = "";
                        if (null !== b) if (b = B(b, d, c), d = null === b || "" === b ? "" : b.toString(), "tsv" === a.type) b instanceof Date && b.toLocaleString(), k = da(d, "\t", " "); else if (b instanceof Date) k = a.csvEnclosure + b.toLocaleString() + a.csvEnclosure; else if (k = wa(d), k = da(k, a.csvEnclosure, a.csvEnclosure +
            ...
            try {
                C = new Blob([z], {type: "text/plain;charset=utf-8"}),
            ...
            l = "";
            l = "head" === a.jsonScope ? JSON.stringify(V) :
                "data" === a.jsonScope ? JSON.stringify(ma) : JSON.stringify({header: V, data: ma});
            ...
            try {
                ...
                G(a.fileName +
                    ".xml", "data:application/xml;charset=utf-8;base64,", N)
            }
                    ...
                    d(a).each(function () {
                        ...
                        D(this, "td,th", n, c + a.length, function (a, c, f) {
                            if (null !== a) {
                                ...
                                c = B(a, c, f);
                                f = "String";
                                if (!1 !== jQuery.isNumeric(c)) f = "Number"; else {
                                    var e = Ha(c);
            ...
            l = {};
            for (var A = {}, m, O, W = 0, aa = E.length; W < aa; W++) m = E[W], O = l[m], O = l[m] = null == O ? 1 : O + 1, 2 === O && (E[A[m]] = E[A[m]].substring(0, 29) + "-1"), 1 < l[m] ? E[W] = E[W].substring(0, 29) + "-" + l[m] : A[m] = W;
            l = '<?xml version="1.0" encoding="UTF-8"?>\r<?mso-application progid="Excel.Sheet"?>\r<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:o="urn:schemas-microsoft-com:office:office"\r xmlns:x="urn:schemas-microsoft-com:office:excel"\r xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:html="http://www.w3.org/TR/REC-html40">\r<DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">\r  <Created>' +
            ...
            for (A = 0; A < na.length; A++) l += '<Worksheet ss:Name="' + E[A] + '" ss:RightToLeft="' + (a.mso.rtl ? "1" : "0") + '">\r' + na[A], l = a.mso.rtl ? l + '<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">\r<DisplayRightToLeft/>\r</WorksheetOptions>\r' : l + '<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel"/>\r', l += "</Worksheet>\r";
            l += "</Workbook>\r";
            if ("string" === a.outputMode) return l;
            if ("base64" === a.outputMode) return J(l);
            try {
                C = new Blob([l], {type: "application/xml;charset=utf-8"}), saveAs(C, a.fileName +
                    ".xml")
            } catch (b) {
            ...
            d(t).each(function () {
                ...
                D(this, "th,td", n, t.length, function (c, f, e) {
                    if ("undefined" !== typeof c && null !== c) {
                        ...
                        if (c || f) f = f || 1, oa.push({
                            s: {r: n, c: b.length},
                            e: {r: n + (c || 1) - 1, c: b.length + f - 1}
                        });
            ...
            try {
                ...
                G(a.fileName +
                    "." + a.mso.fileFormat, "data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8,", ya(l))
            }
            ...
            d(v).filter(function () {
                ...
                var b = d(this);
                "" === Y && (Y = a.mso.worksheetName || b.find("caption").text() || "Table", Y = d.trim(Y.replace(/[\\\/[\]*:?'"]/g,
                    "").substring(0, 31)));
                ...
                d(r).each(function () {
                    ...
                    D(this, "th,td", n, r.length, function (b, e, h) {
                        if (null !== b) {
                            var c = "";
                            p += "<th";
                            for (var k in a.mso.styles) if (a.mso.styles.hasOwnProperty(k)) {
                ...
                d(t).each(function () {
                    ...
                    D(this, "td,th", n, r.length + t.length, function (c, e, g) {
                        if (null !== c) {
                            var k = B(c, e, g), f = "", h = d(c).data("tableexport-msonumberformat");
                            ...
                            for (var l in a.mso.styles) a.mso.styles.hasOwnProperty(l) &&
                            (h = d(c).css(a.mso.styles[l]), "" === h && (h = b.css(a.mso.styles[l])), "" !== h && "0px none rgb(0, 0, 0)" !== h && "rgba(0, 0, 0, 0)" !== h && (f += "" === f ? 'style="' : ";", f += a.mso.styles[l] + ":" + h));
                            p += "<td";
                            "" !== f && (p += " " + f + '"');
                            e = S(c);
                            0 < e && (p += ' colspan="' + e + '"');
                ...
                a.displayTableName && (H += "<tr><td></td></tr><tr><td></td></tr><tr><td>" + B(d("<p>" + a.tableName + "</p>")) +
                    "</td></tr>");
                H += "</tbody></table>"
            });
            ...
            "excel" === l && (m += "\x3c!--[if gte mso 9]>", m += "<xml>", m += "<x:ExcelWorkbook>", m += "<x:ExcelWorksheets>", m += "<x:ExcelWorksheet>", m += "<x:Name>", m += Y, m += "</x:Name>", m += "<x:WorksheetOptions>", m += "<x:DisplayGridlines/>", a.mso.rtl && (m += "<x:DisplayRightToLeft/>"), m += "</x:WorksheetOptions>",
                m += "</x:ExcelWorksheet>", m += "</x:ExcelWorksheets>", m += "</x:ExcelWorkbook>", m += "</xml>", m += "<![endif]--\x3e");
            m += "<style>";
            ...
            m += "@page Section2 {size:" + L[a.mso.pageFormat][1] + "pt " + L[a.mso.pageFormat][0] +
                "pt";
        ...
        } else if ("png" === a.type) html2canvas(d(v)[0]).then(function (b) {
            b = b.toDataURL();
            ...
            if ("window" === a.outputMode) window.open(b); else try {
                C = new Blob([e], {type: "image/png"}), saveAs(C, a.fileName + ".png")
            } catch (k) {
                G(a.fileName +
                    ".png", "data:image/png,", C)
            }
            ...
            l =
                {
                    dim: {w: ca(d(v).first().get(0), "width", "mm"), h: ca(d(v).first().get(0), "height", "mm")},
                    pagesplit: !1
                };
            ...
            "undefined" !== typeof e.images && (d(v).filter(function () {
                return Q(d(this))
            }).each(function () {
                var b = 0;
                F = [];
                !1 === a.exportHiddenCells &&
                (I = d(this).find("tr, th, td").filter(":hidden"), U = 0 < I.length);
                r = u(d(this));
                t = w(d(this));
                d(t).each(function () {
            ...
            Ga(e, function () {
                d(v).filter(function () {
                    ...
                    "function" !== typeof c.createdHeaderCell && (c.createdHeaderCell =
                        function (a, b) {
                            ...
                            if ("undefined" !== typeof e.columns[b.column.dataKey]) {
                                ...
                                "undefined" !== typeof g.style && !0 !== g.style.hidden && ("inherit" === c.headerStyles.halign && (a.styles.halign = g.style.align), "inherit" === c.styles.fillColor && (a.styles.fillColor = g.style.bcolor), "inherit" === c.styles.textColor && (a.styles.textColor = g.style.color), "inherit" === c.styles.fontStyle && (a.styles.fontStyle = g.style.fstyle))
                            }
                        });
                    "function" !==
                    typeof c.createdCell && (c.createdCell = function (a, b) {
                    ...
                    "function" !== typeof c.drawCell && (c.drawCell = function (a, b) {
                        ...
                        if (!0 !== ("undefined" !== typeof c && c.isCanvas)) ra(a, b, c) && (e.doc.rect(a.x, a.y, a.width, a.height, a.styles.fillStyle), "undefined" !== typeof c && "undefined" !== typeof c.elements &&
                        c.elements.length ? (b = a.height / c.rect.height, b > e.hScaleFactor && (e.hScaleFactor = b), e.wScaleFactor = a.width / c.rect.width, b = a.textPos.y, ua(a, c.elements, e), a.textPos.y = b, va(a, c.elements, e)) : va(a, {}, e)); else {
                            c = c.elements[0];
                            var g = d(c).attr("data-tableexport-canvas"), f = c.getBoundingClientRect();
                    ...
                    d(r).each(function () {
                        b = 0;
                        e.headerrows[n] = [];
                        D(this, "th,td", n, r.length, function (a,
                                                                d, c) {
                            var g = xa(a);
                            g.title = B(a, d, c);
                            g.key = b++;
                    ...
                    if (0 < n) for (var f = n - 1; 0 <= f;) d.each(e.headerrows[f], function () {
                        var a = this;
                    ...
                    d(t).each(function () {
                        ...
                        D(this, "td,th", n, r.length + t.length, function (c, f, g) {
                            if ("undefined" === typeof e.columns[b]) {
                                var k =
                                    {title: "", key: b, style: {hidden: !0}};
                                e.columns.push(k)
                            }
                            "undefined" !== typeof c && null !== c ? (k = xa(c), k.isCanvas = c.hasAttribute("data-tableexport-canvas"), k.elements = k.isCanvas ? d(c) : d(c).children()) : (k = d.extend(!0, {}, e.teCells[h + ":" + (b - 1)]), k.colspan = -1);
                            e.teCells[h + ":" + b++] = k;
                            a.push(B(c, f, g))
                        });
                    ...
                    if ("function" === typeof e.onAfterAutotable) e.onAfterAutotable(d(this),
                        c);
